            ...
            <head>
                ...
                <script>
                    ...
                    ss.DocumentReady(function () {
                        var editor = document.getElementById("Editor").appendChild(new WYSIWYG());
                        var sd = new SuperDialog();
                        var autosavetime = 60 * 5;

                        editor.DesignMode(true);
                        editor.EditorCSS('width: 100%;height: 512px;');
                        ...
                        ss.Post("../../../../Api/Ajax/Editor/GetHtmlData.php", {"FullPath": ss.URLParam()["path"]}, function (data) {
                        ...
                        ss.S("#BNOpen").Click(function () {
                            ...
                            SaveBeforeExit.OnDiscard = function () {
                                ...
                                window.location.replace("NewDoc.php");
                    ...
                    <div class="Nav">
                        ...
                        <div class="BorderBlock" style="margin-top: 1px;">
                            ...
                            <ul>
                                ...
                                <li style="font-weight: bold;">WYSIWYG</li>

        ...
        <head>
            ...
            <script>
                ...
                ss.DocumentReady(function () {
                    ...
                    ss.S("#BNClearSQLCode").Click(function () {
                        ss.S("#TXTSQLCode").Val("");
                    });
                    ss.S("#BNEXECSQLCode").Click(function () {
                        ss.Post("../../../../Api/Ajax/SQLite/EXECSQLCode.php", {"path": ss.URLParam()["path"], "Query": ss.S("#TXTSQLCode").Val()}, function (data) {
                            ss.S("#EXECOutput").Html(data);
                        });
                    });
        ...
        <body style="">
            ...
            <div class="Container">
                ...
                <div class="Section" style="box-sizing: border-box;">
                    <span>SQL Code</span>
                    <textarea id="TXTSQLCode" style="width: 100%;box-sizing: border-box;min-height: 200px;display: block;resize: vertical;"></textarea>
                    <div style="text-align: right;">
                        <button id="BNClearSQLCode">Clear</button>
                        <button id="BNEXECSQLCode">EXEC</button>
                    </div>

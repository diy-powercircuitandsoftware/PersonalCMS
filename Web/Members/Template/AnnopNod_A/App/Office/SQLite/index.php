            ...
            <script>
                ...
                ss.DocumentReady(function () {
                    ...
                    fd.OpenDir = function (v) {
                        ajax.Post("../../../../../Api/Ajax/Files/List/GetFilesListByExtension.php", {"Path": v, "Ext": 'db,sqlite'}, function (data) {
                            fd.CurrentDir = v;
                    ...
                    ss.S("#BNNew").Click(function () {
                        ...
                        var p = sd.Prompt("Enter File Name", function (v) {
                            ajax.Post("../../../../../Api/Ajax/Office/SQLite/Manager/CreateSQLiteFile.php", {"Path": fd.CurrentDir, "Name": v}, function (data) {

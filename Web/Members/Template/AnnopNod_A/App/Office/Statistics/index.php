            ...
            <script>
                ...
                ss.DocumentReady(function () {
                    ...
                    fd.OpenDir = function (v) {
                        ajax.Post("../../../../../Api/Ajax/Files/List/GetFilesListByExtension.php", {"Path": v, "Ext": "StatisticsZip"}, function (data) {
                            fd.CurrentDir = v;
                            ...
                            for (var i in data) {
                                if (data[i]["type"] == "DIR") {
                                    ...
                                    fd.AddFile(data[i]["name"], data[i]["fullpath"], data[i]["size"], data[i]["modified"]);
                                }
                            }
                              fd.RemoveEditable();
                        });
                    ...
                    fd.OpenFile = function (v) {
                        window.location.replace("Basic.php?path=" + (v));
                    };

                    ss.S("#BNNew").Click(function () {
                        
                        var p = sd.Prompt("Enter File Name", function (v) {
                            ajax.Post("../../../../../Api/Ajax/Office/Statistics/Manager/CreateStatisticsZip.php", {"Path": fd.CurrentDir, "Name": v}, function (data) {

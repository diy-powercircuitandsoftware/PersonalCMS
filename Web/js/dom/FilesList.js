class FilesList {
    ...
    AddFile(name, path, size, date) {
        ...
        lastrow.innerHTML = this.StringFormat('<td><input data-domfileslist="Select" type="checkbox" /></td><td>%s %s</td><td>%s</td><td>%s</td><td><a style="text-decoration: none;color: blue;" data-domfileslist="Open" href="#">Open</a>&nbsp;<a style="text-decoration: none;color: blue;" data-isbnedit="yes" data-domfileslist="Rename" href="#">Rename</a>&nbsp;<a style="text-decoration: none;color: blue;" data-isbnedit="yes" data-domfileslist="Delete" href="#" >Delete</a>&nbsp;<a style="text-decoration: none;color: blue;" data-domfileslist="Properties" href="#">Properties</a>&nbsp;<a style="text-decoration: none;color: blue;" data-domfileslist="Download" href="#">Download</a></td>', icon, name, size, date);
    }
    AddDir(name, path, date) {
        ...
        lastrow.innerHTML = this.StringFormat('<td><input data-domfileslist="Select" type="checkbox" /></td><td>%s %s</td><td>-</td><td>%s</td><td><a style="text-decoration: none;color: blue;" data-domfileslist="Open" href="#">Open</a>&nbsp;<a style="text-decoration: none;color: blue;" data-isbnedit="yes" data-domfileslist="Rename" href="#">Rename</a>&nbsp;<a style="text-decoration: none;color: blue;" data-isbnedit="yes" data-domfileslist="Delete" href="#" >Delete</a>&nbsp;<a style="text-decoration: none;color: blue;" data-domfileslist="Properties" href="#">Properties</a>&nbsp;<a style="text-decoration: none;color: blue;" data-domfileslist="Download" href="#">Download</a></td>', icon, name, date);
    }
